...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        Task task1 = new Task(1, "1 Название задачи 1", "1 Описание задачи 1", Status.NEW);
        Task task2 = new Task(2, "2 Название задачи 2", "2 Описание задачи 2", Status.NEW);
        ...
        Epic epic1 = new Epic(3,"1 Название эпик 1", "1 Описание эпик 1", Status.NEW);
        taskManager.addEpic(epic1);
        taskManager.getHistoryManager().addHistory(epic1);
        Epic epic2 = new Epic(7, "2 Название эпик 2", "2 Описание эпик 2", Status.NEW);
        taskManager.addEpic(epic2);
        taskManager.getHistoryManager().addHistory(epic2);
        SubTask subTask1 = new SubTask(4, "1 Название подзадачи 1", "1 Описание подзадачи 1", Status.NEW, epic1.getId());
        taskManager.addSubTask(subTask1);
        taskManager.getHistoryManager().addHistory(subTask1);
        SubTask subTask2 = new SubTask(5, "2 Название подзадачи 2", "2 Описание подзадачи 2", Status.NEW, epic1.getId());
        taskManager.addSubTask(subTask2);
        taskManager.getHistoryManager().addHistory(subTask2);
        SubTask subTask3 = new SubTask(6, "3 Название подзадачи 3", "3 Описание подзадачи 3", Status.NEW, epic1.getId());
